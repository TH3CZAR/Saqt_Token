...
if matches[1] == "ادفر البوتات" or matches[1] == "Leave bots" and is_owner(msg) then
  function clbot(arg, data)
    for k, v in pairs(data.members_) do
      kick_user(v.user_id_, msg.chat_id_)
     end
  tdcli.sendMessage(msg.chat_id_, msg.id_, 1, '<i>تـ๋͜ݥ طـٍرد جـ๋͜مـيـ๋͜ݞ الـ๋͜بـ๋وتـ๋͜ات🤖🏌🏻</i>', 1, 'html')
  end
  tdcli.getChannelMembers(msg.chat_id_, 1, 'Bots', 200, clbot, 'md')
  end


------- ملف موقعي او شنو اني -------
if matches[1]=="شنو اني" and is_sudo(msg) then
return  "انـ๋͜تـﮧ ابـ๋͜ويـ✥ـٍـ๋͜ة آلـ๋͜مـ✥ـٍطـ๋͜ور😽❤️"
...
return "انـ๋͜تـﮧ خـ๋͜الـ✥ـٍو آلـ๋͜مـ✥ـٍديـ๋͜ر 😻🏅"
elseif matches[1]=="شنو اني" and is_mod(msg) then
return "انـ๋͜تـﮧ آبـ๋͜ن عـ๋͜مـ✥ـٍيے اݪأدمـ๋͜ن 😼✌️"
elseif matches[1]=="شنو اني" then
return " انـ๋͜تـﮧ عـ๋͜ظــ๋͜و ݪأ تـ๋͜حـ✥ـٍل وݪأ تـ๋͜ربـ๋͜ط 😹🙌"
...
------- ملف معلوماتي -------
		...
		function get_id(arg, data)
			...
			if data.first_name_ then
				if data.username_ then
					...
					username = 'ݪأ يـ✥ـٍوجـ๋͜د مـ✥ـٍعــ๋͜رف😿💔'
				end
				local lastName
				if data.last_name_ then
					lastName = data.last_name_
				else
					lastName = 'ݪأ يـ✥ـٍوجـ๋͜دأســ๋͜م ثـ✥ـانــ๋͜يے 😿🖊'
				end
				local Your_site
				if is_sudo(msg) then
					Your_site = ' انـ๋͜تـﮧ ابـ๋͜ويـ✥ـٍـ๋͜ة آلـ๋͜مـ✥ـٍطـ๋͜ور😽❤️'
				elseif is_admin(msg) then
                   	Your_site = 'انـ๋͜تـﮧ مـسـ๋͜اعـد ألـ๋͜مطور 😼👏\n يـعـ๋͜ني عـ๋͜مـ๋͜و الـ๋͜مشـ๋͜رف 😻🏅'
				elseif is_owner(msg) then
					Your_site = 'انـ๋͜تـﮧ خـ๋͜الـ✥ـٍو آلـ๋͜مـ✥ـٍديـ๋͜ر 😻🏅'
				elseif is_mod(msg) then
					Your_site = 'انـ๋͜تـﮧ آبـ๋͜ن عـ๋͜مـ✥ـٍيے اݪأدمـ๋͜ن 😼✌️'
				else
					Your_site = ' انـ๋͜تـﮧ عـ๋͜ظــ๋͜و ݪأ تـ๋͜حـ✥ـٍل وݪأ تـ๋͜ربـ๋͜ط 😹🙌'
				end
				local Dev_Tln 
	 			if is_mod(msg) then
					Dev_Tln = '@Ch_Dev'
    ...
    local text = ' <b>مـ✥ـٍعـلـ๋͜ومـاتــ๋͜ك حــ๋͜بـ✥ـيــ๋͜قــيے 😽❤️ :- </b>\n<b>➖🔷➖🔺{T.L.N}🔺➖🔷➖</b>\n\n<code>آݪأســ๋͜م آݪأول 😻💋:- </code> \n\n <i>[</i> <b> '..data.first_name_..' </b> <i>]</i>\n\n<code>آݪأســ๋͜م آݪــ๋͜ثـ✥ـانــ๋͜يے 😿🖊 :- </code> \n\n <i>[</i> <b> '..lastName..' </b> <i>]</i>\n\n<code>آلـ๋͜مـ✥ـٍعـرفـ๋͜ 📍😼 :-</code> \n<i>[</i> '..username..' <i>]</i>\n<code>آݪأيــ๋͜ديے 🆔 :-</code> \n <i>[</i> <b> '..data.id_..' </b><i>]</i>\n<code>أيــ๋͜ديے آلـ๋͜كـ✥ـٍروبـﮧ 👥🆔 :- </code> \n <i>[</i> <b> '..arg.chat_id..' </b> <i>]</i>\n<code>مــ๋͜وقـ✥ـٍعــ๋͜ك حــ๋͜بـ✥ـيــ๋͜قــيے 😺✨:- </code> \n <i>[</i> <b> '..Your_site..'</b> <i>]</i>\n\n<b>➖🔷➖🔻{T.L.N}🔻➖🔷➖</b>\n<b>تــ๋͜يــ๋͜م ألــ๋͜رئـ✥ـآســ๋͜ة 🌝💫</b> \n <i>[</i> '..Dev_Tln..' <i>]</i>'
